...
export class RegistroHistoriaComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.form = this.fb.group({
      ...
      altura: [this.historiaAux.altura, [Validators.min(50), Validators.max(220)]],
      peso: [this.historiaAux.peso, [Validators.min(1), Validators.max(220)]],
      temperatura: [this.historiaAux.temperatura, [Validators.min(34), Validators.max(45)]],
      presion: [this.historiaAux.presion, [Validators.min(2), Validators.max(30)]],
  ...
  generarOtrosDatos()
  {
    ...
    let datoDos = this.form.value.datoDosClave+'$$'+this.form.value.datoDosValor;
    let datoTres = this.form.value.datoTresClave+'$$'+this.form.value.datoTresValor;
